...
import PwrInSpace from '../assets/images/Pwr_in_Space_whiteBG.png'
        ...
        <div className="inner">
            <section>
                ...
                <input class="form-data" name="email" type="email" placeholder="Wpisz tu twój email" required />
                        ...
                        <label class="half" aria-live="polite">
                            Twoję imię
                <input class="form-data" name="name" type="text" placeholder="Wpisz tu twoje imię" required />
                        </label>

                        <label class="half" aria-live="polite">
                            Temat
                <input class="form-data" type="text" name="_subject" placeholder="Wpisz tu temat wiadomości" minlength="4"
                                maxlength="78" required />
                        </label>
